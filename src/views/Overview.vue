    ...
    getCompanyDevicesFeed: function() {
        ...
        .then(
            response => {
                ...
                const deviceFeedItemsToKeep = ['GPS Latitude', 'GPS Longitude', 'Fuel Rate', 'Key Position', 'Inlet Pressure', 'Flow Rate', 'Engine Speed', 'Outlet Pressure 1', 'Battery Voltage', 'Engine Coolant Temp', 'Engine Oil Pressure', 'Fuel Level', 'Amber Warning Lamp', 'Red Stop Lamp']
                // .holding_registers
